...
# OpenCode model in "provider/model" format (e.g. anthropic/claude-...,
# openai/gpt-..., deepseek/deepseek-chat). When unset, OpenCode uses its own
# configured default model.
DEFAULT_OPENCODE_MODEL = os.environ.get('OPENCODE_MODEL') or None
